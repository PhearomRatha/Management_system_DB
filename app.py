...
event_parser.add_argument('start_time', type=str, required=True, help="Start time (HH:MM) is required")
event_parser.add_argument('end_time', type=str, required=True, help="End time (HH:MM) is required")
